 ...
 */
@Slf4j
public class CatchTaskDetailWrapper extends TaskDetailWrapper {
   ...
   */
  public CatchTaskDetailWrapper(TaskDetail taskDetail) {
    super(taskDetail);
  }
  ...
  public Optional<TaskDetail> call() throws Exception {
    ...
    try {
      // 尝试执行任务详情的call方法
      return getTaskDetail().call().map(CatchTaskDetailWrapper::new);
    } catch (Exception e) {
